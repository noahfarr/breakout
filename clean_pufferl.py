...
def rollout(
    ...
    if frames:
        ...
        os.makedirs("../docker", exist_ok=True) or imageio.mimsave(
            "../docker/eval.gif", frames, fps=15, loop=0
        )
...
def print_dashboard(
    ...
    dashboard = Table(
        box=ROUND_OPEN, expand=True, show_header=False, border_style="bright_cyan"
    )
